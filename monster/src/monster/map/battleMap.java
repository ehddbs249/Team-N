...
public class battleMap extends JFrame{
	...
	String bsText = null;
	public battleMap(Player p, Monster m) {
		...
		Inven.setBounds(600, 270, 160, 30);
		...
		ImageIcon PI = new ImageIcon("player.png");
		ImageIcon MI = new ImageIcon("enemy.png");
		
		playerImg.setIcon(PI);
		monsterImg.setIcon(MI);
		
		playerImg.setBounds(30, 30, 120, 130);
