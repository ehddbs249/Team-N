...
public class battleMap9 extends JFrame{
	
	String bsText = null;
	public battleMap9(Player p, Monster m) {
		...
		ImageIcon MI = new ImageIcon("Baby_Dragon.png");
		...
		Image updateImg1 = img1.getScaledInstance(150, 150, Image.SCALE_SMOOTH);
